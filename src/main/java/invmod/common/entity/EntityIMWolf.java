...
public class EntityIMWolf extends EntityWolf
{
  ...
  public boolean interact(EntityPlayer player)
  {
    ...
    if (itemstack != null)
    {
      if ((itemstack.getItem() == Items.bone) && (player.getDisplayName().equalsIgnoreCase(getOwnerName())) && (this.dataWatcher.getWatchableObjectByte(30) == 1))
      {
      ...
      if ((itemstack.getItem() == mod_Invasion.itemStrangeBone) && (player.getDisplayName().equalsIgnoreCase(getOwnerName())))
      {

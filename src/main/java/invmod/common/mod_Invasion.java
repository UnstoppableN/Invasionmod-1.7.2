	...
	public static void sendMessageToPlayers(HashMap<String, Long> hashMap, String message) {
		if (hashMap != null) {
			for (Map.Entry entry : hashMap.entrySet())
	        {
	          ...
	          sendMessageToPlayer((EntityPlayerMP)FMLCommonHandler.instance().getMinecraftServerInstance().getConfigurationManager().getPlayerForUsername((String) entry.getKey()),message);
	        }
		}
	}
